  ...
  return (
    <div
      className={cn(
        ...
        hoverable && "transition-all duration-200 hover:shadow-float hover:border-slate-300",
        className
      )}
      {...props}
    >
...
export function CardFooter({
  ...
  return (
    <div
      className={cn("p-5 bg-slate-50/50 border-t border-slate-100 flex items-center", className)}
      {...props}
    >
      {children}
    </div>
